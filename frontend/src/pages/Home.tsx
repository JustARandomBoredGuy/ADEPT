...
const Home = () => {
  ...
  if (!user || user === undefined) {
    return (
      <div className="h-screen w-screen flex p-0 m-100 flex-col md:flex-row items-center h-screenr">
        <div role="status">
  ...
  return (
    <div>
      ...
      <div className="mt-8 ml-16">Email: {email} CreatedAt: {new Date(createdAt).toLocaleDateString("en-IN")}</div>
